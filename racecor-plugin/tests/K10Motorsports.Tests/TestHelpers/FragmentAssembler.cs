...
namespace K10Motorsports.Tests.TestHelpers
{
    /// <summary>
    ...
    public class FragmentAssembler
    {
        ...
        public void LoadFragmentsFromJson(string json)
        {
            ...
            {
                Console.WriteLine("[K10Motorsports.FragmentAssembler] Empty JSON provided");
                return;
            }
            ...
            try
            {
                ...
                Console.WriteLine($"[K10Motorsports.FragmentAssembler] Loaded {_fragments.Count} fragment topics");
            }
            catch (Exception ex)
            {
                Console.Error.WriteLine($"[K10Motorsports.FragmentAssembler] Failed to load fragments: {ex.Message}");
            }
        }
