# K10Motorsports.Tests — Comprehensive Test Suite
...
├── K10Motorsports.Tests.csproj       .NET 6.0 project file, NUnit + NUnit3TestAdapter
├── README.md                         This file
│
...
1. Copy the latest version from `plugin/K10Motorsports.Plugin/Engine/TriggerEvaluator.cs`
2. Change namespace to `K10Motorsports.Tests.TestHelpers`
...
- name: Run tests
  run: dotnet test tests/K10Motorsports.Tests/K10Motorsports.Tests.csproj
