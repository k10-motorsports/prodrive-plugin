...
namespace RaceCorProDrive.Tests.TestHelpers
{
    ...
    public class FragmentAssembler
    {
        ...
        public void LoadFragmentsFromJson(string json)
        {
            ...
            {
                Console.WriteLine("[RaceCorProDrive.FragmentAssembler] Empty JSON provided");
                return;
            }
            ...
            try
            {
                ...
                Console.WriteLine($"[RaceCorProDrive.FragmentAssembler] Loaded {_fragments.Count} fragment topics");
            }
            catch (Exception ex)
            {
                Console.Error.WriteLine($"[RaceCorProDrive.FragmentAssembler] Failed to load fragments: {ex.Message}");
            }
        }
