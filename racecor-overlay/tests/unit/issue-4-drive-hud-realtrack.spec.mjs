 ...
 * (Mt Panorama) track map CSV at racecor-plugin/simhub-plugin/racecorio-prodrive-data/
...
// These tests replay heading data derived from the actual Bathurst
// (Mt Panorama) track map CSV at racecor-plugin/simhub-plugin/racecorio-prodrive-data/trackmaps/bathurst.csv.
