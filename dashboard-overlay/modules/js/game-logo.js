...
(function() {
  ...
  // Same-edge mapping: dashboard position → logo position
  // Logo goes on the same vertical edge as the dashboard but the opposite
  // horizontal corner — sits at the same row level, other side of screen.
  var OPPOSITE_CORNER = {
    'top-right':       'top-left',
    'top-left':        'top-right',
