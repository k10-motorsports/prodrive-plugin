...
// The dashboard panels sum to ~904px wide at native CSS size.
// We give the iframe exactly that + a small margin so nothing clips.
// The React container is wider (~1024px in max-w-5xl), so we scale
// the iframe UP to fill it. transform:scale on the <iframe> element
// is purely visual — the iframe's internal viewport stays at NATIVE_W,
// so the dashboard CSS layout is untouched.
const NATIVE_W = 910
const NATIVE_H = 290
...
export function DashboardEmbed() {
  ...
  // ── Responsive scaling: container width ÷ native width ──
  useEffect(() => {
